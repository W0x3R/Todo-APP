export const toggleElements = [
	{ selector: 'body', class: 'body_theme-dark' },
	{ selector: '.inner', class: 'inner_theme-dark' },
	{ selector: '.form__title', class: 'form__title_theme-dark' },
	{ selector: '.form__list-item', class: 'form__list-item_theme-dark' },
